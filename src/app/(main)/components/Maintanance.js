...
function Maintanance() {
  return (
    <div className="bg-scroll bg-[url('/Aviation-Maintenance.jpg')] object-cover bg-no-repeat w-full min-h-screen md:h-[400px] relative">
      <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-r from-black to-transparent opacity-95">
        <motion.div
          ...
          viewport={{ once: true }}
          className="mt-10 md:mt-32 mx-4 sm:mx-6 md:mx-10 text-white   w-72 md:w-96 bg-blue-900 p-6 sm:p-8 md:p-8"
        >
